...
public nonisolated enum PB_CommandStatus: SwiftProtobuf.Enum, Swift.CaseIterable {
  ...
  public static let allCases: [PB_CommandStatus] = [
    .ok,
    .error,
    .errorDecode,
    .errorNotImplemented,
...
public nonisolated struct PB_Empty: Sendable {
...
public nonisolated struct PB_StopSession: Sendable {
  // SwiftProtobuf.Message conformance is added in an extension below. See the
  // `Message` and `Message+*Additions` files in the SwiftProtobuf library for
  // methods supported on all messages.
...
public nonisolated struct PB_Main: Sendable {
  // SwiftProtobuf.Message conformance is added in an extension below. See the
  // `Message` and `Message+*Additions` files in the SwiftProtobuf library for
  // methods supported on all messages.
  ...
  public var commandStatus: PB_CommandStatus = .ok

  public var hasNext_p: Bool = false

  public var content: PB_Main.OneOf_Content? = nil

  public var empty: PB_Empty {
    get {
  ...
  public var stopSession: PB_StopSession {
    get {
  ...
  public var systemPingRequest: PBSystem_PingRequest {
    get {
  ...
  public var systemPingResponse: PBSystem_PingResponse {
    get {
  ...
  public var systemRebootRequest: PBSystem_RebootRequest {
    get {
  ...
  public var systemDeviceInfoRequest: PBSystem_DeviceInfoRequest {
    get {
  ...
  public var systemDeviceInfoResponse: PBSystem_DeviceInfoResponse {
    get {
  ...
  public var systemFactoryResetRequest: PBSystem_FactoryResetRequest {
    get {
  ...
  public var systemGetDatetimeRequest: PBSystem_GetDateTimeRequest {
    get {
  ...
  public var systemGetDatetimeResponse: PBSystem_GetDateTimeResponse {
    get {
  ...
  public var systemSetDatetimeRequest: PBSystem_SetDateTimeRequest {
    get {
  ...
  public var systemPlayAudiovisualAlertRequest: PBSystem_PlayAudiovisualAlertRequest {
    get {
  ...
  public var systemProtobufVersionRequest: PBSystem_ProtobufVersionRequest {
    get {
  ...
  public var systemProtobufVersionResponse: PBSystem_ProtobufVersionResponse {
    get {
  ...
  public var systemUpdateRequest: PBSystem_UpdateRequest {
    get {
  ...
  public var systemUpdateResponse: PBSystem_UpdateResponse {
    get {
  ...
  public var systemPowerInfoRequest: PBSystem_PowerInfoRequest {
    get {
  ...
  public var systemPowerInfoResponse: PBSystem_PowerInfoResponse {
    get {
  ...
  public var storageInfoRequest: PBStorage_InfoRequest {
    get {
  ...
  public var storageInfoResponse: PBStorage_InfoResponse {
    get {
  ...
  public var storageTimestampRequest: PBStorage_TimestampRequest {
    get {
  ...
  public var storageTimestampResponse: PBStorage_TimestampResponse {
    get {
  ...
  public var storageStatRequest: PBStorage_StatRequest {
    get {
  ...
  public var storageStatResponse: PBStorage_StatResponse {
    get {
  ...
  public var storageListRequest: PBStorage_ListRequest {
    get {
  ...
  public var storageListResponse: PBStorage_ListResponse {
    get {
  ...
  public var storageReadRequest: PBStorage_ReadRequest {
    get {
  ...
  public var storageReadResponse: PBStorage_ReadResponse {
    get {
  ...
  public var storageWriteRequest: PBStorage_WriteRequest {
    get {
  ...
  public var storageDeleteRequest: PBStorage_DeleteRequest {
    get {
  ...
  public var storageMkdirRequest: PBStorage_MkdirRequest {
    get {
  ...
  public var storageMd5SumRequest: PBStorage_Md5sumRequest {
    get {
  ...
  public var storageMd5SumResponse: PBStorage_Md5sumResponse {
    get {
  ...
  public var storageRenameRequest: PBStorage_RenameRequest {
    get {
  ...
  public var storageBackupCreateRequest: PBStorage_BackupCreateRequest {
    get {
  ...
  public var storageBackupRestoreRequest: PBStorage_BackupRestoreRequest {
    get {
  ...
  public var storageTarExtractRequest: PBStorage_TarExtractRequest {
    get {
  ...
  public var appStartRequest: PBApp_StartRequest {
    get {
  ...
  public var appLockStatusRequest: PBApp_LockStatusRequest {
    get {
  ...
  public var appLockStatusResponse: PBApp_LockStatusResponse {
    get {
  ...
  public var appExitRequest: PBApp_AppExitRequest {
    get {
  ...
  public var appLoadFileRequest: PBApp_AppLoadFileRequest {
    get {
  ...
  public var appButtonPressRequest: PBApp_AppButtonPressRequest {
    get {
  ...
  public var appButtonReleaseRequest: PBApp_AppButtonReleaseRequest {
    get {
  ...
  public var appButtonPressReleaseRequest: PBApp_AppButtonPressReleaseRequest {
    get {
  ...
  public var appGetErrorRequest: PBApp_GetErrorRequest {
    get {
  ...
  public var appGetErrorResponse: PBApp_GetErrorResponse {
    get {
  ...
  public var appDataExchangeRequest: PBApp_DataExchangeRequest {
    get {
  ...
  public var guiStartScreenStreamRequest: PBGui_StartScreenStreamRequest {
    get {
  ...
  public var guiStopScreenStreamRequest: PBGui_StopScreenStreamRequest {
    get {
  ...
  public var guiScreenFrame: PBGui_ScreenFrame {
    get {
  ...
  public var guiSendInputEventRequest: PBGui_SendInputEventRequest {
    get {
  ...
  public var guiStartVirtualDisplayRequest: PBGui_StartVirtualDisplayRequest {
    get {
  ...
  public var guiStopVirtualDisplayRequest: PBGui_StopVirtualDisplayRequest {
    get {
  ...
  public var gpioSetPinMode: PBGpio_SetPinMode {
    get {
  ...
  public var gpioSetInputPull: PBGpio_SetInputPull {
    get {
  ...
  public var gpioGetPinMode: PBGpio_GetPinMode {
    get {
  ...
  public var gpioGetPinModeResponse: PBGpio_GetPinModeResponse {
    get {
  ...
  public var gpioReadPin: PBGpio_ReadPin {
    get {
  ...
  public var gpioReadPinResponse: PBGpio_ReadPinResponse {
    get {
  ...
  public var gpioWritePin: PBGpio_WritePin {
    get {
  ...
  public var gpioGetOtgMode: PBGpio_GetOtgMode {
    get {
  ...
  public var gpioGetOtgModeResponse: PBGpio_GetOtgModeResponse {
    get {
  ...
  public var gpioSetOtgMode: PBGpio_SetOtgMode {
    get {
  ...
  public var appStateResponse: PBApp_AppStateResponse {
    get {
  ...
  public var propertyGetRequest: PBProperty_GetRequest {
    get {
  ...
  public var propertyGetResponse: PBProperty_GetResponse {
    get {
  ...
  public var desktopIsLockedRequest: PBDesktop_IsLockedRequest {
    get {
  ...
  public var desktopUnlockRequest: PBDesktop_UnlockRequest {
    get {
  ...
  public var desktopStatusSubscribeRequest: PBDesktop_StatusSubscribeRequest {
    get {
  ...
  public var desktopStatusUnsubscribeRequest: PBDesktop_StatusUnsubscribeRequest {
    get {
  ...
  public var desktopStatus: PBDesktop_Status {
    get {
...
public nonisolated struct PB_Region: Sendable {
  // SwiftProtobuf.Message conformance is added in an extension below. See the
  // `Message` and `Message+*Additions` files in the SwiftProtobuf library for
  // methods supported on all messages.

  public var countryCode: Data = Data()

  public var bands: [PB_Region.Band] = []

  public var unknownFields = SwiftProtobuf.UnknownStorage()

  public nonisolated struct Band: Sendable {
    // SwiftProtobuf.Message conformance is added in an extension below. See the
    // `Message` and `Message+*Additions` files in the SwiftProtobuf library for
    // methods supported on all messages.
    ...
    public var powerLimit: Int32 = 0

    public var dutyCycle: UInt32 = 0
...
nonisolated extension PB_CommandStatus: SwiftProtobuf._ProtoNameProviding {
...
nonisolated extension PB_Empty: SwiftProtobuf.Message, SwiftProtobuf._MessageImplementationBase, SwiftProtobuf._ProtoNameProviding {
  ...
  public static func ==(lhs: PB_Empty, rhs: PB_Empty) -> Bool {
    if lhs.unknownFields != rhs.unknownFields {return false}
    return true
  }
}

nonisolated extension PB_StopSession: SwiftProtobuf.Message, SwiftProtobuf._MessageImplementationBase, SwiftProtobuf._ProtoNameProviding {
  ...
  public static func ==(lhs: PB_StopSession, rhs: PB_StopSession) -> Bool {
    if lhs.unknownFields != rhs.unknownFields {return false}
    return true
  }
}

nonisolated extension PB_Main: SwiftProtobuf.Message, SwiftProtobuf._MessageImplementationBase, SwiftProtobuf._ProtoNameProviding {
  public static let protoMessageName: String = _protobuf_package + ".Main"
  ...
  public static func ==(lhs: PB_Main, rhs: PB_Main) -> Bool {
...
nonisolated extension PB_Region: SwiftProtobuf.Message, SwiftProtobuf._MessageImplementationBase, SwiftProtobuf._ProtoNameProviding {
  public static let protoMessageName: String = _protobuf_package + ".Region"
  public static let _protobuf_nameMap = SwiftProtobuf._NameMap(bytecode: "\0\u{3}country_code\0\u{1}bands\0")
  ...
  public static func ==(lhs: PB_Region, rhs: PB_Region) -> Bool {
...
nonisolated extension PB_Region.Band: SwiftProtobuf.Message, SwiftProtobuf._MessageImplementationBase, SwiftProtobuf._ProtoNameProviding {
  public static let protoMessageName: String = PB_Region.protoMessageName + ".Band"
  public static let _protobuf_nameMap = SwiftProtobuf._NameMap(bytecode: "\0\u{1}start\0\u{1}end\0\u{3}power_limit\0\u{3}duty_cycle\0")
  ...
  public static func ==(lhs: PB_Region.Band, rhs: PB_Region.Band) -> Bool {
